...
We'll be using the **CO2** data set that comes default with R. (note: use `data()` to see a list of all available datasets).
 ...
 - Experiment: CO$_2$ uptake of 12 plants (6 each from Quebec and Mississippi) was measured at several levels of ambient CO$_2$ concentration. Half the plants of each type were chilled overnight before the experiment was conducted.
...
We'll start with a scatter plot showing CO$_2$ uptake as a function of CO$_2$ concentration. Our app will be able to control which points are included in the plot based on the plants' `Type` argument. 
